@section('PruebacomentariosEstilos')
...
<div id="comments" class="post-block mt-5 post-comments">
                            ...
                            <div class="post-block mt-5 post-leave-comment">
                                ...
                                <form class="contact-form p-4 rounded bg-color-grey" action="{{route('comentarios.generar')}}" method="POST">	
                                    @csrf {{-- AGREGAMOS EL TOKEN COMO EN LA BARRA NAV --}}		
                                    <div class="p-2">
                                        <div class="row">
                                            <div class="form-group col-lg-6">
                                                <label class="form-label required font-weight-bold text-dark" >Nombre Completo</label>
                                                <input placeholder='Ingrese su Nombre'   type="text" name="name" data-msg-required="Please enter your name." maxlength="100" class="form-control" name="name" required="">
                                            </div> 
                                            <div class="form-group col-lg-6">
                                                <label class="form-label required font-weight-bold text-dark">Correo Electronico</label>
                                                <input placeholder="Email" type="email" value="" data-msg-required="Please enter your email address." data-msg-email="Please enter a valid email address." maxlength="100" class="form-control" name="email" required="">
                                            </div>
                                            <div>
                                                <label>
                                        ...
                                        <div class="row">
                                            <div class="form-group col">
                                                ...
                                                <textarea maxlength="1000" data-msg-required="Please enter your message." rows="8" class="form-control" name="descripcion" required=""></textarea>
                                            </div>
                                        </div>
                                        <div class="row">
